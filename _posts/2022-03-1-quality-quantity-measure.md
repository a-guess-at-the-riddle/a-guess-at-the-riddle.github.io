...
Synergetics, Herman Hakem, J A Scott Kelso, (book), metastability
Wai H Tsang, self-similarity of brain architecture, binary tree search, bidirectional search, combinatorial space, formal axiomatic systems
...
formal concept analysis, extension, intension, comprehension, fuzzy formal concept analysis, order theory, lattice, mathematical property, ...
continuity, defining properities of: Z, Q, R; degeneracy,
Louis Narens, invariance, meaning, ...
dimension, physical dimension, dimensional analysis, similarity, self-similarity, similitude, ...

**unknowns (seemingly unrelated topics, but relevant for other essays)** John Eccles, ...,
Jordan Peterson, psychologcial categories, archetypes, mythology, allegory, ..., averaging, renormalization, statistical representation, democracy, voting, markets, prediction markets, ..., metallurgy, heat treatment, annealing, tempering, simulated annealing, "lower energy state", equilibrium, ..., waves, linear/nonlinear waves, standing waves, bounded waves, resonance, ... homeostasis, ..., reverse mathematics, ..., natural units, ..., anthropic principle, ..., consilience, William Whewell, ...
