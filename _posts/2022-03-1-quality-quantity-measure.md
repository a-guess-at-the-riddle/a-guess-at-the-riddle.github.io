...
Charles Sanders Peirce, *On a New List of Categories*, three grades of clearness, semiotics, icon, index, symbol, Terrence Deacon, *The Symbolic Species*, *Incomplete Nature*, ...
necessity, history of mathematics, number, quantity, discrete, continuous, measure, ..., history of computation, qualitative computation???, discrete computation, analog/real computation, ...
