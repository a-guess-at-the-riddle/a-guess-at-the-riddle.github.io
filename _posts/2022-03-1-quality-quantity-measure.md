...
Speculative metaphysical philosophers like Charles Sanders Peirce, Hegel, and Herbert Spencer extrapolate what I talk about below to their cosmology and metaphysics insisting in the likeness of the evolutionary processes of the physical world and the process of the mind (a kind of theory of everything). An important more recent term that represents much of these ideas about development is self-organization. Of course they wrote about such a concept, for example a very important part of Peirce's philosophy is the concept of habit-formation but generalized beyond what we would be familiar with today.
