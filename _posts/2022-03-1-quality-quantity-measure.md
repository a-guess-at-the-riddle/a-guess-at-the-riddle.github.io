...
**associated topic tags:** quality, semantic dimensions, semantic spaces, conceptual spaces, Peter Gärdenfors, *The Ascent of Man*, Jacob Bronowski, development of complexity, statified stability, phenomenology, perception, developmental psychology, measurement theory, *Foundations of Measurement*, level of measurement, nominal, ordinal, order, interval, ratio, Stanley Smith Stevens, Benjamin Drake Wright, Philosophy of History, Georg Wilhelm Friedrich Hegel, *Science of Logic*, Historicism, Karl Marx, Dialectial Materialsm, Economics, Markets, Communism, History of Economics, ... Charles Sanders Peirce, *On a New List of Categories*, three grades of clearness, semiotics, icon, index, symbol, Terrence Deacon, *The Symbolic Species*, *Incomplete Nature*, necessity, history of mathematics, number, quantity, discrete, continuous, measure, ..., history of computation, qualitative computation???, discrete computation, analog/real computation, ...

**currently researching:** Kenneth D Forbus, *Qualitative Representations*, Jean Piaget, Developmental Psychology, Evolutionary Developmental Biology, Paul D. MacLean, triune brain theory, Evolutionary Neuroscience, Herbert Spencer, *First Principles*, data structures, data structure design space, combinatorial design, incidence structures, formal concept analysis, extension, intension, comprehension, formal concept analysis, order theory, lattice, mathematical property, continuity, defining properities of: Z, Q, R; degeneracy, Louis Narens, dimension, physical dimension, dimensional analysis, similarity, self-similarity, similitude, ...

**unknowns (seemingly unrelated topics, but relevant for other essays)** Wai H Tsang, bidirectional binary search, convergence/divergence, looping back, triadic analogy: formal axiomatic systems; genetics; neuroscience, ..., Jordan Peterson, psychologcial categories, archetypes, mythology, allegory, ..., averaging, renormalization, statistical representation, democracy, voting, markets, prediction markets, ..., metallurgy, heat treatment, annealing, tempering, simulated annealing, "lower energy state", equilibrium, ..., waves, linear/nonlinear waves, standing waves, bounded waves, resonance, ... homeostasis, ..., reverse mathematics, ..., natural units, ..., anthropic principle, ..., consilience, William Whewell, ...Dennis Gabor, holography Karl Pribram, *The Holonomic Brain Theory*, David Bohm, memory, non-locality, correlograph, holographic associative memory, fourier transform, harmonoic analysis
