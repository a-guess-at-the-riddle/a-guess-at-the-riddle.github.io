...
- growth, development, Evolutionary Developmental Biology (evodevo)
...
- cybernetics, second-order cybernetics, W. Ross Ashby, Heinz von Foerster, Gordan Pask
...
- Leon Chua, local activity principle, edge of chaos


- phenomenology, Edmund Husserl, Maurice Merleau-Ponty, phaneroscopy, Charles Sander Peirce, ...
- perception, ecological/direct perception, James Gibson, ...
- developmental psychology, Jean Piaget, ...
- level of measurement, nominal, ordinal, order, interval, ratio, Stanley Smith Stevens, mathematical psychology, Clyde Coombs...
- measurement theory, *Foundations of Measurement*, Patrick Suppes, ...
- Psychometrics, Rasch measurement, Benjamin Drake Wright, classical test theory, item response theory, ...
- Evolution, Charles Darwin, Darwinism, Natural Selection, ...
...
- Peircean semiotics, *On a New List of Categories*, *Three Grades of Clearness*, three grades of clearness, icon, index, symbol, Terrence Deacon, *The Symbolic Species*, *Incomplete Nature*, Floyd Merrell, *Signs Grow*, ...
...
Evolutionary Neuroscience, Paul D. MacLean, triune brain theory, 
Herbert Spencer, *First Principles*, ...
data structures, data structure design space, combinatorial design, incidence structures,
formal concept analysis, extension, intension, comprehension, fuzzy formal concept analysis, order theory, lattice, mathematical property, continuity, defining properities of: Z, Q, R; degeneracy, Louis Narens, dimension, physical dimension, dimensional analysis, similarity, self-similarity, similitude, ...

**unknowns (seemingly unrelated topics, but relevant for other essays)** Wai H Tsang, bidirectional binary search, convergence/divergence, looping back, triadic analogy: formal axiomatic systems; genetics; neuroscience, John Eccles, ..., Jordan Peterson, psychologcial categories, archetypes, mythology, allegory, ..., averaging, renormalization, statistical representation, democracy, voting, markets, prediction markets, ..., metallurgy, heat treatment, annealing, tempering, simulated annealing, "lower energy state", equilibrium, ..., waves, linear/nonlinear waves, standing waves, bounded waves, resonance, ... homeostasis, ..., reverse mathematics, ..., natural units, ..., anthropic principle, ..., consilience, William Whewell, ...
...
- fourier series, fourier transform, harmonic analysis

- numerical analysis, floating-point, validated numerics, interval arithmetic, ...
- Leon Chua
